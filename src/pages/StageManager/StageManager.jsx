  ...
  const columns = React.useMemo(
    () => [
      ...
      },
      {
        ...
        key: "kyc_verified",
        render: (text) => (
          <img width={"25px"} src={text ? RightMark : CrossMark} alt="" />
        ),
      },
      {
      ...
      },
      {
        ...
        render: (text, row) => (
          <Dropdown
            overlay={
              <Menu>
                <Menu.Item onClick={() => handleGenerateContract(row)}>
                  {row.contract_issued ? "Revoke" : "Generate"} Contract
                </Menu.Item>
                <Menu.Item
                  onClick={() => handleGenerateContract(row, "reject")}
                >
                  Reject Contract
                </Menu.Item>
              </Menu>
