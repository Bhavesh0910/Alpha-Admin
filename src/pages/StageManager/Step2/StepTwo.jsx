...
const StepTwo = () => {
  ...
  const stagesOption = location.pathname === "/support/step-2" ? ["Stage 1 Pass", "Stage 2 Pass"] : [];
  ...
  async function fetchStageList(idToken, pageNo, pageSize, searchText, status, dates) {
    ...
    if (location.pathname === "/support/step-2") {
      category = "STEP 2";
      type = stage === "Stage 1 Pass" ? "Stage 1 Pass" : stage === "Stage 2 Pass" ? "Stage 2 Pass" : "stage 1 Pass";
