...
export const fetchCompDetails = createAsyncThunk(
  'comp/fetchCompDetails',
...
export const createCompetition = createAsyncThunk(
  'comp/createCompetition',
  async ({ idToken, formData }, { dispatch, rejectWithValue }) => {
    try {
...
export const updateCompetition = createAsyncThunk(
  'comp/updateCompetition',
  async ({ idToken, id, updatedData }, { dispatch, rejectWithValue }) => {
