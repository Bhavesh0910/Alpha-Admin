...
import { getAffiliateListV2, getCodelistV2, postAffiliateDetails } from '../../utils/api/apis';
...
export const fetchAffiliateList = createAsyncThunk(
  ...
  async ({      idToken,
    pageNo,
    pageSize,
    searchText, }, { dispatch, rejectWithValue }) => {
    try {
      const response = await getAffiliateListV2(      idToken,
      pageNo,
      pageSize,
      searchText,);
